...
public enum GlobeWorldSize {
    ITTY_BITTY(Text.literal("Itty Bitty (7,500 x 7,500)"), Identifier.of("globe", "globe_xsmall"), 3750),
    TINY(Text.literal("Tiny (10,000 x 10,000)"),           Identifier.of("globe", "globe_small"), 5000),
    SMALL(Text.literal("Small (15,000 x 15,000)"),         Identifier.of("globe", "globe_regular"), 7500),
