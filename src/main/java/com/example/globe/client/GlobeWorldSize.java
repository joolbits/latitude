...
public enum GlobeWorldSize {
    XSMALL("Extra-Small (7,500 x 7,500)", Identifier.of("globe", "globe_xsmall"), 3750),
    SMALL("Small (10,000 x 10,000)",     Identifier.of("globe", "globe_small"),  5000),
    REGULAR("Regular (15,000 x 15,000)", Identifier.of("globe", "globe_regular"), 7500);
