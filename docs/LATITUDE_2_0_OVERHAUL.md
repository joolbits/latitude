...
- `<external-notes>/longitude-earthlike-world-overhaul-20260702.md`
...
Read `<external-notes>/model-effort-strategy-20260702.md` before starting any phase below. Short version: most of
...
- Record the pivot in external record, porting docs, and release gates.
...
- `AGENTS.md`
- `<external-notes>/index.md`
- `<external-notes>/update-contract.md`
- `<external-notes>/evidence-registry.md`
- `<external-notes>/longitude-earthlike-world-overhaul-20260702.md`
...
- Metrics delta external record note.
...
overhaul that rode along. Single source of truth: `<external-notes>/polar-experience-reference-20260712.md`
(system reference: every constant, flag, mixin, dial, dead end). Run-by-run history:
`<external-notes>/phase5-boundary-experience-plan-20260709.md`. **B-5 Hemisphere Passage SHIPPED 2026-07-12** (merged, default ON, live-approved by Peetsa + a full
...
`<external-notes>/phase5-b5-hemisphere-passage-design-20260710.md` (design + all P1-P3 build/verdict logs).
...
`<external-notes>/phase5-b6-teleport-evator-design-20260712.md` (branch-only file). REMAINING in Phase 5
...
- Biome-geography audit (<external-notes>/fable5-biome-geography-audit-20260707.md) — what the fields already
...
- external record plan + run log per slice; LESSONS on durable rules.
...
<external-notes>/model-effort-strategy-20260702.md for why.

READ FIRST (in order):
1. docs/LATITUDE_2_0_OVERHAUL.md (front door — read the whole thing)
2. <external-notes>/model-effort-strategy-20260702.md
3. <external-notes>/longitude-earthlike-world-overhaul-20260702.md
4. docs/porting/PORTING.md and docs/porting/VERSION_MATRIX.md
5. docs/porting/PORTING.md (main worktree) — especially L7 (working card discipline)
...
DELIVERABLE: a dated external record note recording what was verified, the branch/worktree
...
4. <external-notes>/model-effort-strategy-20260702.md
...
DELIVERABLE: a dated external record note recording what layers/types/flags were added, the
...
in `<external-notes>/biome-consumer-slice-20260704.md`. The land-reroll half is ready to enable; the
...
findings, all fixed/dispositioned — `<external-notes>/biome-consumer-sweeper-fixes-20260705.md`) and once
comprehensively over the rest of Phases 0-3 (27 more findings, all fixed/dispositioned —
`<external-notes>/sweeper-audit-2-phases-0-3-20260705.md`). Flag-off byte-identical re-confirmed after both
...
`<external-notes>/phase4-prep-research-20260705.md`).
...
does not default to Opus the way Phase 2/3 did. See <external-notes>/model-effort-strategy-20260702.md.
...
curiosities: the supercontinent tail (<external-notes>/phase2-geoauthority-20260703.md residual risk #1,
tune via -Dlatitude.geoV2.lplateRatio) and the aggressive alpine cooling (<external-notes>/phase3-
...
4. <external-notes>/phase2-geoauthority-20260703.md and <external-notes>/phase3-climateauthority-20260703.md
...
DELIVERABLE: a dated external record note recording the integration-boundary decision, what was wired, the
...
and lives in `<external-notes>/phase4-prep-research-20260705.md` — read that in full before this prompt; it is
...
Biome Consumer slice's model tier. Consider a judge-panel workflow (per `<external-notes>/model-effort-
...
already-designed-but-unimplemented amplitude wrapper (`<external-notes>/amplitude-df-wrapper-design-20260622.md`)
...
READ FIRST (in order):
1. `<external-notes>/phase4-prep-research-20260705.md` (this phase's own document-review step, done ahead of
...
3. `<external-notes>/amplitude-df-wrapper-design-20260622.md` (a related-but-different, still-unimplemented
...
4. `<external-notes>/spark-profile-analysis-20260701.md` (the unresolved ~3-minute freeze; neither a code
...
DELIVERABLE: a dated external record note recording the height-export validation results, the before/after
...
- `<external-notes>/model-effort-strategy-20260702.md` — which model/reasoning-effort per phase, and what a future
  thread can/can't self-adjust automatically.
- `<external-notes>/longitude-earthlike-world-overhaul-20260702.md`
- `<external-notes>/current-state-handoff-20260701.md`
- `<external-notes>/test1-live-findings-20260701.md`
- `<external-notes>/atlas-worldshape-longitude-20260701.md`
...
- `docs/porting/VERSION_MATRIX.md`
- `docs/porting/PORTABILITY_ARCHITECTURE.md`
- `<external-notes>/phase0-portability-foundation-20260703.md`
- `<external-notes>/phase1-measurement-harness-20260703.md`
- `docs/design/atlas-geography-overlay-plan-20260703.md`
- `docs/design/geoauthority-design-20260703.md`
- `<external-notes>/phase2-geoauthority-20260703.md`
- `docs/design/climateauthority-design-20260703.md`
- `<external-notes>/phase3-climateauthority-20260703.md`
